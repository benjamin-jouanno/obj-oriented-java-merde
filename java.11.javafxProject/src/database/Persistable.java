...
//			DEBUG: System.err.println( "An SQL Error Occured:" + sqle + "\n" + sqle.getErrorCode() + "\n" + sqle.getMessage() + "\n" + sqle);
					...
					Properties where)
    {
		...
		try
		{
			...
			database.SQLSelectStatement theSQLStatement = new database.SQLSelectStatement(schema, where);
...
//			DEBUG: System.err.println( "An SQL Error Occurred:" + sqle + "\n" + sqle.getErrorCode() + "\n" + sqle.getMessage() + "\n" + sqle);
									 ...
									 Properties where)
    {
		...
		try
		{
	    	...
	    	// construct a SQL statement from the passed parameters
			database.SQLQueryStatement theSQLStatement = new database.SQLQueryStatement(selSchema, projectionSchema, where);
...
//			DEBUG: 
									 ...
									 Properties where)
    {
		...
		try
		{
	    	...
	    	// construct a SQL statement from the passed parameters
			database.SQLQueryStatementWithExactMatches theSQLStatement =
				new database.SQLQueryStatementWithExactMatches(selSchema, projectionSchema, where);
...
//			DEBUG: System.err.println( "An SQL Error Occurred:" + sqle + "\n" + sqle.getErrorCode() + "\n" + sqle.getMessage() + "\n" + sqle);
			...
			throws SQLException
    {
		...
		try
		{
	    	...
	    	// construct a SQL statement from the passed parameters
			database.SQLUpdateStatement theSQLStatement = new database.SQLUpdateStatement(schema, updateValues, whereValues);
			// DEBUG System.out.println("SQL Statement: " + theSQLStatement.toString());
 ...
 //------------------------------------------------------------
				...
				throws SQLException
    {
		...
		try
		{
			...
			// construct a SQL statement from the passed parameters
			database.SQLInsertStatement theSQLStatement = new database.SQLInsertStatement(schema, insertValues);
